      ...
      <div className="hero-container">
        <div className="hero-content">
          ...
          <p className="hero-subtitle animate-slide-up-delayed">
            {t(
              "hero_subtitle",
              "OpenOura ir nākamās paaudzes platforma uzņēmumiem, kas vēlas sasniegt vairāk. Apvieno projektus, darbiniekus un procesus vienā viedā ekosistēmā.",
            )}
          </p>
        ...
        <div className="hero-visual animate-float">
            ...
            <div className="card-body-visual">
              ...
              <div className="timeline-container">
                ...
                <div className="timeline-track">
                  <div
                    className="timeline-task purple"
                    style={{ left: "10%", width: "34%" }}
                  >
                    ...
                    <div className="task-tooltip">
                      ...
                      <div className="tooltip-time">
                        {t("task_done")}: 07:15 — 08:30 (1h 15m)
                      </div>
                      <div className="tooltip-time">
                        {t("task_planned")}: 1h 04m
                      </div>
                      <div className="tooltip-time">
                        {t("task_efficiency")}: 85%
                      </div>
          ...
          <div className="floating-card task-card animate-float-slow">
            ...
            <div>
              ...
              <span>
                {t(
                  "floating_card_project_cost",
                  "Izmaksāja 98 000€ | 28% peļņa",
                )}
              </span>
            </div>
          </div>
